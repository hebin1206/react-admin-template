...
const RightPanel = (props) => {
  ...
  const [topMenu, setTopMenu] = useState(defaulTopMenu);
  ...
  const topMenuChange = (checked) => {
    setTopMenu(checked);
    changeSetting({ key: "topMenu", value: checked });
  };
      ...
      >
        ...
        <Row>
          ...
          <Col span={12}>
            <Switch
              checkedChildren="菜单"
              unCheckedChildren="面包屑"
              defaultChecked={topMenu}
              onChange={topMenuChange}
            />
          </Col>
        </Row>
        <Divider dashed />
